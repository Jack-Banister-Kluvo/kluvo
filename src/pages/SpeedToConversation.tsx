...
const SpeedToConversation = () => {
  const calendarLink = "https://calendar.app.google/vaWE3nyxS6UwYqtc6";
  const pdfPath = "/downloads/Speed_to_Conversation.pdf";
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1">
        {isMobile ? (
          <MobilePdfViewer 
            pdfPath={pdfPath} 
            title="Speed to Conversation - Kluvo Research" 
          />
        ) : (
          <iframe
            src={pdfPath}
...
export default SpeedToConversation;
